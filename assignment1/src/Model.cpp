...
void Model::DrawInstanced(const glm::mat4& model_matrix, const glm::mat4& view_matrix, const glm::mat4& projection_matrix, const std::vector<glm::mat4>& model_matrices)
{
    unsigned int shader_program = LoadShaders("../src/shader.vert", "../src/shader.frag");
